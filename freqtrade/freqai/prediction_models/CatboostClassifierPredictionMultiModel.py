...
class CatboostClassifierPredictionMultiModel(IFreqaiModel):
    ...
    def build_strategy_return_arrays(
        ...
        if pair not in self.dd.model_return_values:
            ...
            self.dd.set_initial_return_values(pair, dk, pred_df, do_preds, classify=True)
        ...
        self.dd.append_model_predictions(pair, pred_df, do_preds, dk, len(dataframe), classify=True)
        dk.return_dataframe = self.dd.attach_return_values_to_return_dataframe(pair, dataframe)
